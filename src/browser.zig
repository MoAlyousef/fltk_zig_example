...
pub const Browser = struct {
    ...
    pub fn handle(self: *Browser, cb: fn (w: ?*c.Fl_Widget, ev: i32 data: ?*c_void) callconv(.C) i32, data: ?*c_void) void {
        c.Fl_Browser_handle(self.inner, cb, data);
    }

    pub fn draw(self: *Browser, cb: fn (w: ?*c.Fl_Widget, data: ?*c_void) callconv(.C) void, data: ?*c_void) void {
...
pub const SelectBrowser = struct {
    ...
    pub fn handle(self: *SelectBrowser, cb: fn (w: ?*c.Fl_Widget, ev: i32 data: ?*c_void) callconv(.C) i32, data: ?*c_void) void {
        c.Fl_Select_Browser_handle(self.inner, cb, data);
    }

    pub fn draw(self: *SelectBrowser, cb: fn (w: ?*c.Fl_Widget, data: ?*c_void) callconv(.C) void, data: ?*c_void) void {
...
pub const HoldBrowser = struct {
    ...
    pub fn handle(self: *HoldBrowser, cb: fn (w: ?*c.Fl_Widget, ev: i32 data: ?*c_void) callconv(.C) i32, data: ?*c_void) void {
        c.Fl_Hold_Browser_handle(self.inner, cb, data);
    }

    pub fn draw(self: *HoldBrowser, cb: fn (w: ?*c.Fl_Widget, data: ?*c_void) callconv(.C) void, data: ?*c_void) void {
...
pub const MultiBrowser = struct {
    ...
    pub fn handle(self: *MultiBrowser, cb: fn (w: ?*c.Fl_Widget, ev: i32 data: ?*c_void) callconv(.C) i32, data: ?*c_void) void {
        c.Fl_Multi_Browser_handle(self.inner, cb, data);
    }

    pub fn draw(self: *MultiBrowser, cb: fn (w: ?*c.Fl_Widget, data: ?*c_void) callconv(.C) void, data: ?*c_void) void {
...
pub const FileBrowser = struct {
    ...
    pub fn handle(self: *FileBrowser, cb: fn (w: ?*c.Fl_Widget, ev: i32 data: ?*c_void) callconv(.C) i32, data: ?*c_void) void {
        c.Fl_File_Browser_handle(self.inner, cb, data);
    }

    pub fn draw(self: *FileBrowser, cb: fn (w: ?*c.Fl_Widget, data: ?*c_void) callconv(.C) void, data: ?*c_void) void {

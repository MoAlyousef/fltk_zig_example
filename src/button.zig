...
pub const Button = struct {
    ...
    pub fn handle(self: *Button, cb: fn (w: ?*c.Fl_Widget, ev: i32 data: ?*c_void) callconv(.C) i32, data: ?*c_void) void {
        c.Fl_Button_handle(self.inner, cb, data);
    }

    pub fn draw(self: *Button, cb: fn (w: ?*c.Fl_Widget, data: ?*c_void) callconv(.C) void, data: ?*c_void) void {
...
pub const RadioButton = struct {
    ...
    pub fn handle(self: *RadioButton, cb: fn (w: ?*c.Fl_Widget, ev: i32 data: ?*c_void) callconv(.C) i32, data: ?*c_void) void {
        c.Fl_Radio_Button_handle(self.inner, cb, data);
    }

    pub fn draw(self: *RadioButton, cb: fn (w: ?*c.Fl_Widget, data: ?*c_void) callconv(.C) void, data: ?*c_void) void {
...
pub const CheckButton = struct {
    ...
    pub fn handle(self: *CheckButton, cb: fn (w: ?*c.Fl_Widget, ev: i32 data: ?*c_void) callconv(.C) i32, data: ?*c_void) void {
        c.Fl_Check_Button_handle(self.inner, cb, data);
    }

    pub fn draw(self: *CheckButton, cb: fn (w: ?*c.Fl_Widget, data: ?*c_void) callconv(.C) void, data: ?*c_void) void {
...
pub const RoundButton = struct {
    ...
    pub fn handle(self: *RoundButton, cb: fn (w: ?*c.Fl_Widget, ev: i32 data: ?*c_void) callconv(.C) i32, data: ?*c_void) void {
        c.Fl_Round_Button_handle(self.inner, cb, data);
    }

    pub fn draw(self: *RoundButton, cb: fn (w: ?*c.Fl_Widget, data: ?*c_void) callconv(.C) void, data: ?*c_void) void {

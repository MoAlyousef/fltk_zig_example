...
pub const Group = struct {
    ...
    pub fn handle(self: *Group, cb: fn (w: ?*c.Fl_Widget, ev: i32 data: ?*c_void) callconv(.C) i32, data: ?*c_void) void {
        c.Fl_Group_handle(self.inner, cb, data);
    }

    pub fn draw(self: *Group, cb: fn (w: ?*c.Fl_Widget, data: ?*c_void) callconv(.C) void, data: ?*c_void) void {
...
pub const Pack = struct {
    ...
    pub fn handle(self: *Pack, cb: fn (w: ?*c.Fl_Widget, ev: i32 data: ?*c_void) callconv(.C) i32, data: ?*c_void) void {
        c.Fl_Pack_handle(self.inner, cb, data);
    }

    pub fn draw(self: *Pack, cb: fn (w: ?*c.Fl_Widget, data: ?*c_void) callconv(.C) void, data: ?*c_void) void {
...
pub const Tabs = struct {
    ...
    pub fn handle(self: *Tabs, cb: fn (w: ?*c.Fl_Widget, ev: i32 data: ?*c_void) callconv(.C) i32, data: ?*c_void) void {
        c.Fl_Tabs_handle(self.inner, cb, data);
    }

    pub fn draw(self: *Tabs, cb: fn (w: ?*c.Fl_Widget, data: ?*c_void) callconv(.C) void, data: ?*c_void) void {
...
pub const Scroll = struct {
    ...
    pub fn handle(self: *Scroll, cb: fn (w: ?*c.Fl_Widget, ev: i32 data: ?*c_void) callconv(.C) i32, data: ?*c_void) void {
        c.Fl_Scroll_handle(self.inner, cb, data);
    }

    pub fn draw(self: *Scroll, cb: fn (w: ?*c.Fl_Widget, data: ?*c_void) callconv(.C) void, data: ?*c_void) void {

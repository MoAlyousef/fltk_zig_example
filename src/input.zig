...
pub const Input = struct {
    ...
    pub fn handle(self: *Input, cb: fn (w: ?*c.Fl_Widget, ev: i32 data: ?*c_void) callconv(.C) i32, data: ?*c_void) void {
        c.Fl_Input_handle(self.inner, cb, data);
    }

    pub fn draw(self: *Input, cb: fn (w: ?*c.Fl_Widget, data: ?*c_void) callconv(.C) void, data: ?*c_void) void {
...
pub const MultilineInput = struct {
    ...
    pub fn handle(self: *MultilineInput, cb: fn (w: ?*c.Fl_Widget, ev: i32 data: ?*c_void) callconv(.C) i32, data: ?*c_void) void {
        c.Fl_Multiline_Input_handle(self.inner, cb, data);
    }

    pub fn draw(self: *MultilineInput, cb: fn (w: ?*c.Fl_Widget, data: ?*c_void) callconv(.C) void, data: ?*c_void) void {
...
pub const IntInput = struct {
    ...
    pub fn handle(self: *IntInput, cb: fn (w: ?*c.Fl_Widget, ev: i32 data: ?*c_void) callconv(.C) i32, data: ?*c_void) void {
        c.Fl_Int_Input_handle(self.inner, cb, data);
    }

    pub fn draw(self: *IntInput, cb: fn (w: ?*c.Fl_Widget, data: ?*c_void) callconv(.C) void, data: ?*c_void) void {
...
pub const FloatInput = struct {
    ...
    pub fn handle(self: *FloatInput, cb: fn (w: ?*c.Fl_Widget, ev: i32 data: ?*c_void) callconv(.C) i32, data: ?*c_void) void {
        c.Fl_Float_Input_handle(self.inner, cb, data);
    }

    pub fn draw(self: *FloatInput, cb: fn (w: ?*c.Fl_Widget, data: ?*c_void) callconv(.C) void, data: ?*c_void) void {
...
pub const SecretInput = struct {
    ...
    pub fn handle(self: *SecretInput, cb: fn (w: ?*c.Fl_Widget, ev: i32 data: ?*c_void) callconv(.C) i32, data: ?*c_void) void {
        c.Fl_Secret_Input_handle(self.inner, cb, data);
    }

    pub fn draw(self: *SecretInput, cb: fn (w: ?*c.Fl_Widget, data: ?*c_void) callconv(.C) void, data: ?*c_void) void {

...
pub const TextDisplay = struct {
    ...
    pub fn handle(self: *TextDisplay, cb: fn (w: ?*c.Fl_Widget, ev: i32 data: ?*c_void) callconv(.C) i32, data: ?*c_void) void {
        c.Fl_Text_Display_handle(self.inner, cb, data);
    }

    pub fn draw(self: *TextDisplay, cb: fn (w: ?*c.Fl_Widget, data: ?*c_void) callconv(.C) void, data: ?*c_void) void {
...
pub const TextEditor = struct {
    ...
    pub fn handle(self: *TextEditor, cb: fn (w: ?*c.Fl_Widget, ev: i32 data: ?*c_void) callconv(.C) i32, data: ?*c_void) void {
        c.Fl_Text_Editor_handle(self.inner, cb, data);
    }

    pub fn draw(self: *TextEditor, cb: fn (w: ?*c.Fl_Widget, data: ?*c_void) callconv(.C) void, data: ?*c_void) void {
